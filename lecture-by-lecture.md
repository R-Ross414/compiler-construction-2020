...
- **[Lecture 5.2](https://hackmd.io/@alexhkurz/rk5PsF2EI)**: How to produce a `.info`-file? How does shift-reduce parsing work?  *Homework:* Do the exercises from the lecture notes. These exercises are relevant for tests and final.
...
